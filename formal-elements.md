...
# כותרת ראשית: Handyman

**tagline: Just do it yourself**

## מהות המשחק

הרעיון המרכזי של המשחק הוא דרך כיפית בה ילדים ואו מבוגרים יוכלו ללמוד לבצע פעולות בסיסיות לאחזקת הבית מבלי להזמין בעלי מקצוע וזאת מבלי להתייחס לזה כאל למידה אלא כמשחק שבו בכל שלב של המשחק השחקן יצטרך לבציע תיקונים מסויימים בבית על מנת לסים את המשימה.
המשחק מיועד להיות משחק מחשב.
<img width="386" alt="image" src="https://github.com/AsafGame/Handyman/assets/93122554/2b9be9b2-e668-464d-8844-30f98d26e161">
